CREATE OR REPLACE PROCEDURE WEATHER_DB_VM.DM_WEATHER_VM.SP_PLP_LATEST_WEATHER_DTL()
RETURNS VARCHAR(100)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS 
$$  
    ...
    var merge_statement1 =` MERGE INTO DM_WEATHER_VM.DM_LATEST_WEATHER_DTL TGT USING
      ...
      AND WD.TGT_UPDATE_DT > LWD.TGT_UPDATE_DT
    ...
    var merge_statement2 =` INSERT INTO DM_WEATHER_VM.DM_LATEST_WEATHER_DTL
      ...
      WHERE WD.TGT_UPDATE_DT > (SELECT MAX(TGT_UPDATE_DT) FROM DM_WEATHER_VM.DM_LATEST_WEATHER_DTL);`;
